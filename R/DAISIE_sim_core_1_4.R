...
#' @param island_spec Matrix with runtime simulation data
#' @param stt_table Matrix with species-through-time information on immigrant,
#' anagenetic, cladogenetic and total number of species.
#'
#' @return DAISIE simulation output object
#' @export
